    ...
    invoicePrintContainer.innerHTML = `
      <div class="printable-invoice-card" id="printableInvoiceNode">
        ...
        <div class="inv-top-header-wrap">
          <img src="assets/invoice-header.png" class="inv-top-banner-img" alt="AarambhX Technology" crossorigin="anonymous">
        </div>
        ...
        <div class="inv-bottom-footer-wrap">
          <img src="assets/invoice-footer.png" class="inv-bottom-banner-img" alt="AarambhX Technology Footer" crossorigin="anonymous">
        </div>
      </div>
    `;
