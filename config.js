...
const TBS_CONFIG = {
  ...
  serviceCategories: [
    ...
    { id: 'office', icon: 'box', label: 'Prebuilt Software & Tools', emoji: '📦' },
  ...
  softwareServices: [
    ...
    },
    {
      ...
      icon: 'box',
      title: 'Prebuilt Software & System Tools',
      description: 'Comprehensive library of prebuilt, tested and configured software — creative suites, development tools, OS builds, utilities, drivers, and productivity software.',
      features: [
        'Operating Systems & Windows Setup',
        'AutoCAD, Architecture & CAD Tools',
        'Photoshop, Graphic & Video Editors',
        'Office Tools, Excel & PDF Suites',
        'Antivirus, Security & System Tweaks',
        'Development IDEs, Compilers & DLLs',
        'Disk Management & Data Recovery',
        'Audio Tools, DAWs & Media Players',
      ],
      cta: 'Get Prebuilt Software',
      ctaSection: 'contact',
    },
    {
      id: 'design',
    ...
    projects: [
      {
        ...
        desc: 'Next-Generation Enterprise Gate Security, Visitor Lifecycle & Campus Intelligence Platform with WebRTC photo check-in, anti-replay QR gate checkout, emergency SOS broadcast channel, and direct POS thermal printing.',
        tags: ['Enterprise Security', 'VMS', 'Multi-Tenant', 'WebRTC Camera', 'Anti-Replay QR', 'POS Thermal Print', 'SOS Broadcast'],
        diagram: ['Front Desk WebRTC Camera & Mobile Check-In', 'Anti-Replay QR Token Gate Checkout (html5-qrcode)', 'Emergency SOS HTML5 BroadcastChannel & Flash Alert', 'Executive White-Label Branding Studio (3 Surfaces)', 'POS 80mm Direct Thermal Receipt Print Engine'],
        bom: [
          'Mobile-First Check-In & Live WebRTC Camera Photo Capture',
          'Smart Phone Auto-Fill: 10-Digit Instant Visitor Record Lookup',
          'Anti-Replay QR Scanner (html5-qrcode) with Encrypted Tokens',
          'Emergency SOS Broadcast Channel & Real-Time Alert Banner',
          'Executive White-Label Branding Studio (Digital, Thermal, Lanyard)',
          'Direct POS 80mm / 4x6" Thermal Receipt CSS Printing Engine',
          'Soft-Archiving & Audit-Safe Purging Engine (Zero Data Loss)'
        ],
        deliverables: [
          'Production-Grade Source Code & Multi-Tenant Deployment',
          'Front Desk Gate Reception Portal & Tablet Photo Ingress',
          'Branch Principal Executive Analytics & Security Blacklist Dashboard',
          'Direct POS Thermal Print Configuration & Admin Setup Guide'
        ]
      },
      {
        id: 'lab-ledger',
        ...
        desc: 'Collegiate Computer Science & IT Digital Laboratory Management System using Google Gemini Vision OCR, fuzzy trigram matching, hardware defect tracking, and NAAC/NBA audit reporting.',
        tags: ['Institutional AI', 'Gemini Vision OCR', 'PostgreSQL pg_trgm', 'PWA / Service Worker', 'CWE-1236 Sanitized Excel', 'FastAPI'],
        diagram: ['Handwritten Ledger Mobile / Desktop Camera', 'In-Browser Canvas Downscaling & Gemini OCR', 'PostgreSQL pg_trgm Roster Matching Engine', 'Hardware Maintenance Ticket Aggregator', 'NAAC / NBA Audit PDF & Excel Dispatcher'],
        bom: [
          'Multimodal Google Gemini Vision OCR Ingestion Pipeline (2.5-Flash / 2.5-Pro fallback)',
          'PostgreSQL Fuzzy Trigram (pg_trgm) Student Roster Matcher',
          'Interactive Data Grid with In-Place Cell Editing & Faculty Lock',
          'Hardware Defect Tracker & Workstation Maintenance Alerting',
          'Analytical Attendance & Capacity Utilization Intelligence',
          'Inspection-Ready PDF Reports & CWE-1236 Sanitized Excel Exports',
          'Progressive Web App (PWA) with Offline Service Worker Caching'
        ],
        deliverables: [
          'Production OCR Pipeline & Collegiate Administrative Dashboard',
          'Student Roster Synchronization & Trigram Database Schema',
          'Hardware Maintenance Module & NAAC/NBA Compliance Reports',
          'PWA Offline Service Worker & Campus LAN Setup Guide'
        ]
      },
      {
        id: 'concert-entry',
  ...
  footerLinks: {
    ...
    software: [
      ...
      { label: 'Prebuilt Software', href: '#services' },
