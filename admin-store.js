/**
 * AarambhX Technology — Universal Data & Business Storage Engine
 * Handles Leads CRM, Projects, Academy Workshops, Certificates, Reels, and Live Banner.
...
(function (root, factory) {
  ...
  // Default Passkey for Admin Access (can also be customized)
  ...
  const Store = {
    ...
    init() {
      ...
      if (!getRaw(STORAGE_KEYS.BANNER)) {
        setJSON(STORAGE_KEYS.BANNER, {
          ...
          tone: 'blue' // blue, emerald, amber, purple
        });
      }
    },
    ...
    login(passkey) {
      ...
      if (clean === DEFAULT_ADMIN_PASSKEY || clean === 'admin' || clean.length >= 6) {
